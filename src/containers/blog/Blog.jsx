...
const Blog = () => (
  <div className="inferno__blog section__padding" id="blog">
    <div className="inferno__blog-heading">
      <h1 className="gradient__text">A lot is happening, <br /> We are blogging about it.</h1>
    </div>
    <div className="inferno__blog-container">
      <div className="inferno__blog-container_groupA">
        <Article imgUrl={blog01} date="Sep 26, 2021" text="GPT-3 and Open  AI is the future. Let us exlore how it is?" />
      </div>
      <div className="inferno__blog-container_groupB">
